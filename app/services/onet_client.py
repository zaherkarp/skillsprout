...
class MockONetClient(ONetClient):
    ...
    MOCK_OCCUPATIONS = {
        ...
        # --- High AI exposure occupations (Anthropic labor market paper) ---
        "15-1251.00": {
            "code": "15-1251.00",
            "title": "Computer Programmers",
            "description": "Create, modify, and test the code and scripts that allow computer applications to run. Work from specifications drawn up by software and web developers or other individuals.",
            "job_zone": 4,
            "education": "Bachelor's degree",
        },
        "43-4051.00": {
    ...
    MOCK_SKILLS = {
        ...
        "15-1251.00": [
            {"element_id": "2.B.1.g", "skill_name": "Programming", "importance": 87.0, "level": 6.00},
        ...
        "43-4051.00": [
            {"element_id": "2.B.2.a", "skill_name": "Active Listening", "importance": 81.0, "level": 5.62},
            {"element_id": "2.B.4.a", "skill_name": "Speaking", "importance": 78.0, "level": 5.38},
            {"element_id": "2.B.1.a", "skill_name": "Reading Comprehension", "importance": 72.0, "level": 5.00},
            {"element_id": "2.B.1.f", "skill_name": "Service Orientation", "importance": 81.0, "level": 5.62},
            {"element_id": "2.B.7.a", "skill_name": "Social Perceptiveness", "importance": 72.0, "level": 5.00},
            {"element_id": "2.B.3.c", "skill_name": "Negotiation", "importance": 66.0, "level": 4.62},
            {"element_id": "2.B.8.a", "skill_name": "Critical Thinking", "importance": 66.0, "level": 4.62},
        ],
        "43-9021.00": [
            {"element_id": "2.B.1.a", "skill_name": "Reading Comprehension", "importance": 66.0, "level": 4.50},
